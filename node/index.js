...
var client = mqtt.connect("mqtt://masterclassiot.ga", options);
...
client.on('message', function (topic, message) {
  ...
  if (topic == "values"){
    ...
    var query = "INSERT INTO `admin_datos`.`data` (`data_temp1`, `data_temp2`, `data_volts`) VALUES (" + temp1 + ", " + temp2 + ", " + volts + ");";
